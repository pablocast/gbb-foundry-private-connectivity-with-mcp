        ...
        if output.success and output.json_data:
            ...
            if output.success and output.json_data:
                for resource in output.json_data:
                    ...
                    print_info(f"Deleting AI Foundry project '{resource_name}' in resource group '{resource_group_name}'...")
                    output = run(f'az resource delete --ids "{resource_id}"', f"AI Foundry project '{resource_name}' deleted", f"Failed to delete AI Foundry project '{resource_name}'")
            ...
            if output.success and output.json_data:
                for resource in output.json_data:
                    ...
                    print_info(f"Deleting and purging Cognitive Service Account '{resource_name}' in resource group '{resource_group_name}'...")
